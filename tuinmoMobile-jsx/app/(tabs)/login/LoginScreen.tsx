...
// ⚠️ IMPORTA AQUÍ TUS COMPONENTES NATIVOS
...
const styles = StyleSheet.create({
  ...
  // Simulación del "wave" violeta: una franja fija arriba
  topBackground: {
    position: 'absolute',
    top: 0,
    left: 0,
    ...
    backgroundColor: '#5617A4', // puedes ajustar al gradiente que usabas
    zIndex: -1,
  },
  contentWrapper: {
    flex: 1,
    paddingHorizontal: 16,
    paddingTop: 60, // para despegar del header violeta
    paddingBottom: 60, // dejar espacio a la barra inferior
    justifyContent: 'center',
  },
  // Botón "Portal alquileres"
  portalButton: {
    position: 'absolute',
    top: 20,
    right: 20,
